...
const ContestTestPage = () => {
  ...
  const championPower = phase === 'live' ? Math.round((championTipVotes + championSample) / 2) : 0;
  const challengerPower = phase === 'live' ? Math.round((challengerTipVotes + challengerSample) / 2) : 0;
