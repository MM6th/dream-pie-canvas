...
import IndependentContractorDefinitionModal from "@/components/IndependentContractorDefinitionModal";
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center gap-4 p-4 bg-gray-700/50 rounded-lg">
          <div className="flex flex-col items-start space-y-2">
            <IndependentContractorDefinitionModal>
              <Button 
                variant="link" 
                className="text-blue-400 hover:text-blue-300 p-0 h-auto justify-start"
              >
                Independent Contractor Definition (NY State)
              </Button>
            </IndependentContractorDefinitionModal>
