      ...
      {useCarousel ? (
        ...
        >
          <CarouselContent className="-ml-0.5">
            {posts.map((post) => (
              <CarouselItem key={post.id} className="pl-0.5 md:basis-1/2 lg:basis-1/3 xl:basis-1/4">
                {renderCard(post)}
              </CarouselItem>
            ))}
          </CarouselContent>
        ...
        <div className="relative">
          ...
          >
            <CarouselContent className="-mt-0.5 h-[800px]">
              {posts.map((post) => (
                <CarouselItem key={post.id} className="pt-0.5 basis-1/3">
                  {renderCard(post)}
                </CarouselItem>
              ))}
            </CarouselContent>
