...
const CurrentThoughtsSection = ({ posts, useCarousel = true }: CurrentThoughtsSectionProps) => {
        ...
        {post.title_on_the_line && (
          <div className="flex justify-center my-3">
            <div className="relative flex flex-col items-center">
              ...
              <img src={post.challenge_type === 'twerk_off' ? pieTitleTwerk : pieTitleBelt} alt="Championship belt" className={`object-contain drop-shadow-lg ${post.challenge_type === 'twerk_off' ? 'w-[400px] h-[160px]' : 'w-[320px] h-[130px]'}`} loading="lazy" />
  ...
  return (
    <div className="mb-12">
      <h2 className="text-2xl lg:text-3xl font-bold text-white mb-3 flex items-center gap-2">
